...
BEGIN {
  $Capture::Tiny::Extended::VERSION = '0.101';
}
...
Please see the documentation of L<Capture::Tiny> for details on standard usage.
...
L<http://rt.cpan.org/Dist/Display.html?Queue=Capture-Tiny-Extended>
